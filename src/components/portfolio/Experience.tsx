...
const experiences = [
  {
    ...
    description:
      "Working as a Junior Software Developer, contributing to key projects and enhancing software solutions.",
  ...
  },
  {
    ...
    location: "Sivakasi, Tamil Nadu",
    description:
      "Underwent intensive training in software development methodologies and technologies.",
            ...
            <AnimatedSection key={i}>
              <div className="flex gap-10 mb-10 pl-[60px] relative">
                ...
                <div className="flex-1 bg-portfolio-card border border-portfolio-border rounded-2xl p-8 hover:-translate-y-1 hover:border-portfolio-gold/50 hover:shadow-[0_16px_40px_rgba(201,168,76,0.12)] transition-[transform,border-color,box-shadow] duration-300">
                  ...
                  <div className="mb-4">
                    <p className="text-portfolio-gold font-medium text-[15px]">
                      {exp.company}
                    </p>
                    <p className="text-portfolio-muted text-[13px] mb-2">
                      {exp.location}
                    </p>
                  </div>
