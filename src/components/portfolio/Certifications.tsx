        ...
        <div className="grid grid-cols-[repeat(auto-fill,minmax(240px,1fr))] gap-5">
          {certifications.map((cert) => (
            <AnimatedSection key={cert.title}>
              <div className="bg-portfolio-card border border-portfolio-border rounded-2xl p-7 text-center hover:-translate-y-1 hover:border-portfolio-gold/50 hover:shadow-[0_16px_40px_rgba(201,168,76,0.12)] transition-[transform,border-color,box-shadow] duration-300 h-full flex flex-col items-center">
                ...
                <p className="text-portfolio-muted text-[13px] mb-3">
                  {cert.issuer}
                </p>
