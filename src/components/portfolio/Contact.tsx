...
const contactInfo = [
  {
    icon: <Mail size={28} />,
    label: "Email",
    value: "gauthamkeshav1001@gmail.com",
    href: "mailto:gauthamkeshav1001@gmail.com",
  },
  {
    icon: <Phone size={28} />,
    label: "Phone",
    value: "+91 9480218915",
    href: "tel:+919480218915",
  },
  {
    icon: <MapPin size={28} />,
    label: "Location",
  ...
  },
  {
    ...
    label: "GitHub",
    value: "gauthamk010",
    href: "https://github.com/gauthamk010",
    external: true,
  },
  {
    icon: <Linkedin size={28} />,
    label: "LinkedIn",
    value: "Gautham Keshav",
    href: "https://www.linkedin.com/in/gautham-keshav-90a763282",
    external: true,
  },
];
...
export default function Contact() {
  return (
    <section
      id="contact"
      className="py-[100px] px-8 pb-[120px] relative z-10 text-center"
    >
      <div className="max-w-[1000px] mx-auto">
        <AnimatedSection>
          ...
          <p className="text-[16px] leading-[1.8] text-portfolio-muted mb-12">
            I am a tech enthusiast and always open to learning more. Whether you
            have a project, an opportunity, or just want to connect — I'd love
            to hear from you.
          </p>
          ...
          {/* <button
            ...
            onClick={() =>
              (window.location.href = "mailto:gauthamkeshav1001@gmail.com")
            }
          >
            Send Me an Email →
          </button> */}
